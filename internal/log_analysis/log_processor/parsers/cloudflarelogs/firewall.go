...
type FirewallEvent struct {
	...
	Metadata               *pantherlog.RawMessage `json:"Metadata" description:"Additional product-specific information. Metadata is organized in key:value pairs. Key and Value formats can vary by Cloudflare security product and can change over time"`
