...
type HTTPRequest struct {
	...
	CacheResponseStatus            pantherlog.Int64    `json:"CacheResponseStatus" description:"HTTP status code returned by the cache to the edge; all requests (including non-cacheable ones) go through the cache; also see CacheStatus field"`
